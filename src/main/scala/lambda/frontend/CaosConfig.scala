...
import xyz.frontend.Configurator
import xyz.frontend.Configurator.*
import xyz.frontend.widgets.WidgetInfo
import xyz.view.{Mermaid, Text, View, Code}
import lambda.backend.*
import lambda.syntax.Program.Term
import lambda.syntax.{Program, Show}

/** Object used to configure which analysis appear in the browser */
object XyzConfig extends Configurator[Term]:
